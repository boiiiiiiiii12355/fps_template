...
func dialogue_start():
	...
	dialogue_cam_tween.set_trans(Tween.TRANS_CUBIC)
	dialogue_cam_rotation_tween.set_ease(Tween.EASE_IN_OUT)
	dialogue_cam_rotation_tween.set_trans(Tween.TRANS_CUBIC)
